...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO: zweryfikuj nazwę instytutu (np. Instytut Sterowania i Elektroniki Przemysłowej)
\instytut{Instytut Sterowania i Elektroniki Przemysłowej}
% TODO: uzupełnij kierunek i specjalność zgodnie z dyplomem
\kierunek{Elektrotechnika}
\specjalnosc{TODO}
\title{Cyfrowy bliźniak przetwornicy boost DC--DC ze sterowaniem typu bang--bang strojonym algorytmem PSO}
\engtitle{Digital Twin of a DC--DC Boost Converter with PSO-tuned Bang--Bang Control}
% TODO: wpisz numer albumu
\album{TODO}
\author{inż. Rafał Kaczyński}
% TODO: wpisz pełne dane promotora (tytuł, imię, nazwisko)
\promotor{TODO}
\date{2026}
\longdate{2026-09-30}
